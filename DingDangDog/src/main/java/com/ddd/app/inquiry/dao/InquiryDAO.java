...
import com.ddd.app.inquiry.dto.InquiryWritingDTO;
...
public class InquiryDAO {
	...
	// 문의글 삭제 메소드
	public void deleteInquiry(InquiryDetailDTO delteInquiry) {
	...
	// 문의글 작성 메소드
	public void insertInquiry(InquiryWritingDTO inquiryWritingDTO) {
			System.out.println("문의글 작성 - insertinquiry 메소드 실행");
			sqlSession.insert("inquiry.insert", inquiryWritingDTO);
			System.out.println("문의글 작성 쿼리 실행 완료");
	}

	// 문의글 상세 페이지 조회 메소드
	public InquiryListDTO selectInquiry(InquiryDetailDTO inquiryDetailDTO) {
